...
-- ----------------------------
BEGIN;
INSERT INTO `users` (`id`, `email`, `birth_date`, `gender`, `bio`) VALUES (1, 'mary@pure.com', '2000-07-06', 'female', 'I\'m a virgin, I\'m not sure how I got here.');
INSERT INTO `users` (`id`, `email`, `birth_date`, `gender`, `bio`) VALUES (2, 'john@pure.com', '1998-01-24', 'male', 'I\'m a smith, John Smith.');
COMMIT;
